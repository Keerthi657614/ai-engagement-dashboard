...
# ... (Keep your existing CONFIG and HELPERS) ...
...
def analyze_frame(frame):
    ...
    state = "No Face"
    engagement = 0.0
    coords = {"x": 0.5, "y": 0.5} # Default center

    if results.multi_face_landmarks:
        landmarks = results.multi_face_landmarks[0].landmark
        
        # Track Nose Tip for the UI Heatmap
        ...
        engagement = (0.4 * pose_score + 0.3 * gaze_score + 0.3 * eye_score)
